...
const OBLOQ_MQTT_UBIDOTS_SERVER_TK = "industrial.api.ubidots.com"
...
namespace naturalScience {
    ...
    */
    ...
    export function microIoT_MQTT(
        ...
        } else if (servers == SERVERS.Ubidots) {
            microIoT_setPara(SETMQTT_SERVER, OBLOQ_MQTT_UBIDOTS_SERVER_TK)
        } 
        else{microIoT_setPara(SETMQTT_SERVER, IP)}

        if(servers == SERVERS.Ubidots)
            microIoT_setPara(SETMQTT_PORT, "8883")//1883
        else {
